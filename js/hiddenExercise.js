    ...
    class ProductGrid {
      constructor(jsonfilePath, filters, pagination) {
    ...
    var productGrid = new ProductGrid("data/product.json",[{filterName: "color", filterType:"multiple"}, {filterName: "brand", filterType:"multiple"}, {filterName: "sold_out", filterType:"boolean"}], {paginationReq: true, numberOfPages: [3,6,9]});
    productGrid.init();
    });